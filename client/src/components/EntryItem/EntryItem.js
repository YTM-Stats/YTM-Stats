export default function EntryItem({ entry, entryNumber, ...props }) {
  ...
  return (
    <div
      className="flex items-stretch w-full bg-gray-200 rounded-2xl transition-colors
      hover:bg-gray-300 
      "
    >
      <div className={`bg-gray-400 w-[90px]`}>
        <span className="flex justify-start items-center py-1 pl-4 text-xs font-bold text-white bg-gray-500">
          #{entryNumber}
        </span>
      </div>
